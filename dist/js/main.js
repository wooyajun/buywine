...
// 		        str += `<li>
// 							<a href="">
// 								<img src="${this.res.url}" alt="">
// 								<p>${this.res.msg}</p>
// 								<span>${this.res.price}</span>
// 								<em>${this.res.sym}</em>
// 							</a>
// 						</li>`
// 		    }
...
;(function ($) {
	...
	// Pro.prototype.
	// Pro.prototype.image = function (){
	// 	this.imgs=$('#list-ul img');
	// 	for(let i=0;i<this.imgs.length;i++){
	// 		if(this.imgs[i].src==""){
	// 			if(this.imgs[i].offsetTop<(this.scrT + this.cliH)){
    ...
    Pro.prototype.display = function () {
        ...
        for(var i=0;i<this.res.length;i++){
            str += `<li index='${this.res[i].id}'>
						<a href="./xiangqing.html" style="display:inline-block;">
							<img data-src="${this.res[i].url}" alt="">
						</a>
                        <p>${this.res[i].msg}</p>
		...
		onscroll = function(){
			// image = function (){
				that.scrT = document.documentElement.scrollTop;
				that.cliH = document.documentElement.clientHeight;
				that.imgs=$('#list-ul img');
				// console.log(that.imgs[6])
				for(let i=0;i<that.imgs.length;i++){
					if(that.imgs[i].src==""){
						 // console.log(that.imgs[6])
						 // console.log(that.imgs[6].offsetTop)
						 
						if(that.imgs[i].offsetTop<(that.scrT + that.cliH)){
							// console.log(1)
							// console.log(that.scrT)
							// console.log(that.cliH)
